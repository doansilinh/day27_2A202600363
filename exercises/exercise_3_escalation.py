    ...
    with console.status("[dim]LLM reviewing the diff...[/dim]"):
        analysis = calibrate_analysis(llm.invoke([
            {"role": "system", "content": (
                ...
                "2-4 specific, context-rich questions. Reference the file or diff "
                "section that makes each question necessary."
            )},
        ...
        refined = llm.invoke([
            {
                ...
                "content": (
                    ...
                    "reviewer's answers as additional context, update comments and "
                    "confidence, and keep the output structured."
                ),
            },
            {
                "role": "user",
